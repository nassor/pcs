...
//! loop's [`drain_into_dataset`](crate::io::source::drain_into_dataset) would
//! block forever, and
...
//! stream, meaning a schema header plus exactly one `RecordBatch`, as produced
//! by [`arrow_ipc::writer::StreamWriter`].
//!
