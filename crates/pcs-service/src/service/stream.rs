...
//! next item is pulled. There is no inter-item sleep — latency is bounded by
//! the pipeline itself, not by a pacing timer.
//!
...
pub async fn run_stream(
    ...
    loop {
        ...
        // ── 2. Append onto a cleared dataset ─────────────────────────────────
        ...
        // ── 3. Run the pipeline, carrying runtime state forward ──────────────
        ...
        // ── 4. Drain every sink for this item (no per-item finish) ───────────
