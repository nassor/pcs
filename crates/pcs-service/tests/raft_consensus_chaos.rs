...
// Docker-gated cluster tests driven through the `RaftClusterHarness` API.
...
mod cluster {
    ...
    /// Add 200 ms latency on all inbound links for a follower, commit traffic on
